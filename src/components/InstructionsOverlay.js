      ...
      >
        ...
        <ol>
          <li>
            ...
            <p>Click on the <strong>"Choose File"</strong> button to select your CSV file.</p>
            <img src={Step1Image} alt="Choose File Button" className="instruction-image" />
          </li>
          <li>
            <strong>Analyze the Data:</strong>
            <p>Once selected, click on the <strong>"Analyze"</strong> button to process the data.</p>
            <img src={Step2Image} alt="Analyze Button" className="instruction-image" />
          </li>
          <li>
            <strong>Explore Your Data:</strong>
            <p>Use the charts and tables below to explore and interact with your data.</p>
            <img src={Step3Image} alt="Data Visualization" className="instruction-image" />
          </li>
        </ol>
